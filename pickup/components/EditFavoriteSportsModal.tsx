...
export default function EditFavoriteSportsModal({ onClose, onSaved }: EditFavoriteSportsModalProps) {
    ...
    >
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={[styles.headerTitle, { color: colors.text }]}>EDIT FAVORITE SPORTS</Text>
        ...
        {isLoading ? (
          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            <Text style={[styles.sectionTitle, { color: colors.text }]}>All Sports</Text>
